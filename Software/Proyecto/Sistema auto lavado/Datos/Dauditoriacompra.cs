...
namespace Datos
{
    public class Dauditoriacompra
    {
        public List<Eauditoriacompra> obtenerlistacompra()
        {
            try
            {
                ...
                comando.CommandText = "Sp_AUDITORIACOMPRA";
                comando.Connection = conexion;
                conexion.Open();
                SqlDataReader leer = comando.ExecuteReader();
                List<Eauditoriacompra> listacompra = new List<Eauditoriacompra>();
                while (leer.Read())
                {
                    Eauditoriacompra nuevaFila = new Eauditoriacompra();
