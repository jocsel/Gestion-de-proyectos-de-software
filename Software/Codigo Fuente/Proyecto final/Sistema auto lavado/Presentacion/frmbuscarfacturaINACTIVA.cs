...
{
    public partial class frmbuscarfacturaINACTIVA : Form
    {
        ...
        public frmbuscarfacturaINACTIVA()
        {
            InitializeComponent();
        }
        ...
        public void filtrar()
        {
            ...
            if (rbcodigo.Checked)
            {
                ...
                var lista = (from venta in listaventas
                             where   venta.Estado == "Anulada"  &&  venta.Num_venta.ToString().StartsWith(textBox1.Text.ToUpper())
                             select new
                             {
            ...
            {
                var lista = (from venta in listaventas
                             where venta.Estado == "Anulada" && venta.Cliente.idCliente.ToString().StartsWith(textBox1.Text.ToUpper())
                             select new
                             {
                                 Numventa = venta.Num_venta,
                                 venta.Cliente.idCliente,
        ...
        {
            Ninactivo_anulada listam = new Ninactivo_anulada();
            listaventas = listam.obtenerlistventaANULADA();
